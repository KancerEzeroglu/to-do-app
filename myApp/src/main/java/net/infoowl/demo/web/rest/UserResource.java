...
import net.infoowl.demo.config.Constants;
import com.codahale.metrics.annotation.Timed;
import net.infoowl.demo.domain.Authority;
import net.infoowl.demo.domain.User;
import net.infoowl.demo.repository.AuthorityRepository;
import net.infoowl.demo.repository.UserRepository;
import net.infoowl.demo.security.AuthoritiesConstants;
import net.infoowl.demo.service.MailService;
import net.infoowl.demo.service.UserService;
import net.infoowl.demo.web.rest.dto.ManagedUserDTO;
import net.infoowl.demo.web.rest.util.HeaderUtil;
import net.infoowl.demo.web.rest.util.PaginationUtil;
