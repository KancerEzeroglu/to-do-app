...
import static net.infoowl.demo.config.JacksonConfiguration.ISO_DATE_OPTIONAL_TIME;
import static net.infoowl.demo.config.JacksonConfiguration.ISO_FIXED_FORMAT;
