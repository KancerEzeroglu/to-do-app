...
import net.infoowl.demo.config.audit.AuditEventConverter;
import net.infoowl.demo.domain.PersistentAuditEvent;
import net.infoowl.demo.repository.PersistenceAuditEventRepository;
import net.infoowl.demo.service.AuditEventService;
